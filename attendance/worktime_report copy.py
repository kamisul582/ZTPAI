...
from .views import get_employed_user_ids_json,get_worker_from_user,get_employed_worker_ids
...
class WorktimeExportView(View):
    def get(self, request, *args, **kwargs):
        ...
        if 'year' in request.GET and 'month' in request.GET:
            ...
            workers = get_employed_worker_ids(request) #get all manager subordinates or company employees
